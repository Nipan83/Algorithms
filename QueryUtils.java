...
public final class QueryUtils {
     ...
     */
    public static List<earthquakelist> extractFeaturesFromJson(String earthquakejson) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                earthquakelist earthquake = new earthquakelist(magnitude, location, time, url);

                // Add the new {@link Earthquake} to the list of earthquakes.
                earthquakes.add(earthquake);
                Log.e("QueryUtils","Fine...!!!");
            }
    ...
    /**
   //  * Query the USGS dataset and return a list of {@link earthquakelist} objects.
     */
    public static List<earthquakelist> fetchEarthquakeData(String requestUrl) {
        ...
        List<earthquakelist> earthquakes =extractFeaturesFromJson(jsonResponse);
